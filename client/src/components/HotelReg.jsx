...
const HotelReg = () => {
  ...
  const onSubmitHandler = async (e) => {
    e.preventDefault();
    console.log("Submitting hotel registration with data:", { name, address, contact, city });
    try {
      ...
      toast.error(error.response?.data?.message || "An error occurred while registering the hotel");
    }
  };
