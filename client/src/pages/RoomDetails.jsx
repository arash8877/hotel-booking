...
const RoomDetails = () => {
  ...
  useEffect(() => {
    ...
    console.log("Image URL:", room.hotel.owner.image); 
  }, []);
    ...
    room && (
      <div className="py-28 md:py-35 px-4 md:px-16 lg:px-24 xl:px-32">
        ...
        <div className="flex flex-col md:flex-row md:justify-between mt-10">
          ...
          <p className="text-2xl font-medium">DKK {room.pricePerNight}/night</p>
        </div>
        ...
        <div className="max-w-3xl border-y border-gray-300 my-15 py-10 text-gray-500">
          <p>
            ...
            comfortable two bedroom apartment has a true city feeling. The price quoted for two
            guests, at the guest slot please mark the number of guests to get the exact price for
            group.
          </p>
        </div>
